...
export const DocumentCard: React.FC<DocumentCardProps> = ({ doc, onDelete, isAdmin }) => {
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-4 flex items-center justify-between gap-4 hover:border-slate-700 hover:bg-slate-900/60 transition-all duration-200 shadow-sm shadow-black/5">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Delete Document Button (Visible only to Admins) */}
        {isAdmin && (
          <button
            onClick={() => onDelete(doc.id)}
            className="flex h-9 w-9 items-center justify-center rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 transition-all duration-150 focus:outline-none"
